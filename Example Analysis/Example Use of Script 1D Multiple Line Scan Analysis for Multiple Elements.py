...
totallinenumber = 9                         # ENTER THE TOTAL NUMBER OF LINE SCANS; THIS SCRIPT WILL CYCLE THROUGH AND ANALYZE ALL LINE SCANS
...
ElementalExcessFunctions.analysis_usingmultiplelinescans(ANALYSISPATH, datafolder, filename, mainelement4, expectedminormax4, centerelement, centerelementexpectedminormax, totallinenumber, plotcolor4,  atomicvolume, L_guess_nm_alongline, weight, fraction, linescanhalfdistance, integratecutoff, viewplots)
ElementalExcessFunctions.analysis_usingmultiplelinescans(ANALYSISPATH, datafolder, filename, mainelement5, expectedminormax5, centerelement, centerelementexpectedminormax, totallinenumber, plotcolor5,  atomicvolume, L_guess_nm_alongline, weight, fraction, linescanhalfdistance, integratecutoff, viewplots)
